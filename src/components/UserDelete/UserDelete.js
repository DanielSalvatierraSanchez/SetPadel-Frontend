...
export const UserDelete = ({ parentElement, message }) => {
    parentElement.innerHTML = `
            ...
            <button class='btn-delete-yes'><img class="img-btn-delete-yes" src="/assets/yes.png">Sí<img/></button>
            <button class='btn-delete-no'><img class="img-btn-delete-no" src="/assets/close.png">No<img/></button>`;
