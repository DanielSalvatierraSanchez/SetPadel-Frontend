...
export const UserDelete = ({ parentElement, message }) => {
    parentElement.innerHTML = `
            ...
            <button class='btn-delete-yes'><img class="img-btn-delete-yes" src="/assets/yes.webp" alt="yes delete user">Sí<img/></button>
            <button class='btn-delete-no'><img class="img-btn-delete-no" src="/assets/close.webp" alt="no delete user">No<img/></button>`;
