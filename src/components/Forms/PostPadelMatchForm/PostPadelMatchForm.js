...
export const PostPadelMatchForm = (form) => {
    ...
    ${FieldForm({ divClass: "title-container-postPM", inputLabel: "Título", inputClass: "input-title-postPadelMatchForm", inputType: "text", inputPlaceholder: "Título" })}
    ${FieldForm({ divClass: "location-container-postPM", inputLabel: "Ubicación", inputClass: "input-location-postPadelMatchForm", inputType: "text", inputPlaceholder: "Ubicación" })}
    ${FieldForm({ divClass: "date-container-postPM", inputLabel: "Fecha y Hora", inputClass: "input-date-postPadelMatchForm", inputType: "datetime-local", inputPlaceholder: "DD / MM / YYYY - HH : MM" })}
    ${FieldSelect({ divClass: "select-container-postPM", inputLabel: "Tipo de pista", inputClass: "input-select-postPadelMatchForm", inputOption1: "Indoor", inputOption2: "Outdoor" })}
