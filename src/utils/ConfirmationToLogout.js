...
export const confirmationToLogout = ({ parentElement, message }) => {
    parentElement.innerHTML = `
            ...
            <button class='btn-logout-yes'><img class="img-logout-yes" src="/assets/close.png">Sí<img/></button>
            <button class='btn-logout-no'><img class="img-logout-no" src="/assets/yes.png">No<img/></button>`;
